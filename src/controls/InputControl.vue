<template>
  <input :type="type" :readonly="readonly" :value="value" :placeholder="placeholder" @input="onChange($event)"
    @dblclick.stop="" @pointerdown.stop="" @pointermove.stop="" @mousedown.stop />
</template>
